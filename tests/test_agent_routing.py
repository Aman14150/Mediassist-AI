...
class AgentRoutingTests(unittest.TestCase):
    def test_fever_alone_routes_to_general_physician(self):
        ...
        routing = (ROOT / "elevenlabs-knowledge-base" / "02_Services_Routing.txt").read_text(encoding="utf-8")

        self.assertIn("Fever alone", prompt)
        self.assertIn("routes to General Physician", prompt)
        self.assertIn("Fever alone is routed to General Physician", routing)
    ...
    def test_non_crisis_mental_health_concerns_offer_psychology(self):
        ...
        for phrase in ("overthinking", "psychology", "self-care"):
    ...
    def test_psychology_is_bookable_across_sources_and_website(self):
        files = (
            ...
            ROOT / "elevenlabs-knowledge-base" / "02_Services_Routing.txt",
            ROOT / "elevenlabs-knowledge-base" / "03_Doctors.txt",
